...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->C:[J

    const/16 v1, 0x19

    new-array v1, v1, [J

    iput-object v1, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->tempA:[J
...
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/SHA3Digest;)V
    ...
    iget-object p1, p1, Lorg/bouncycastle/crypto/digests/SHA3Digest;->oneByte:[B

    invoke-static {p1}, Lorg/bouncycastle/util/Arrays;->clone([B)[B

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->oneByte:[B
...
.method private absorb([BIJ)V
    ...
    iget v3, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
    ...
    :cond_0
    iget-boolean v3, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->squeezing:Z
    ...
    iget v7, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I

    const-wide/16 v8, 0x8

    if-nez v7, :cond_4

    iget v7, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->rate:I
    ...
    iget-object v7, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->chunk:[B
    ...
    iget-object v4, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->chunk:[B

    const/4 v7, 0x0

    iget-object v8, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->chunk:[B

    array-length v8, v8

    invoke-static {v1, v3, v4, v7, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v3, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->state:[B
    ...
    invoke-direct {v0, v3, v4, v7}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakAbsorb([B[BI)V
    ...
    :cond_3
    iget v3, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->rate:I
    ...
    iget v4, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
    ...
    iget-object v8, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->dataQueue:[B

    iget v9, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
    ...
    iput v7, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
    ...
    invoke-direct/range {p0 .. p0}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->absorbQueue()V
    ...
    iget-object v3, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->dataQueue:[B

    iget v8, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
    ...
    iput v3, v0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
...
.method private chi([J)V
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->chiC:[J
...
.method private doUpdate([BIJ)V
    ...
    invoke-direct {p0, p1, p2, v4, v5}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->absorb([BIJ)V
    ...
    invoke-direct {p0, v4, p2, v2, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->absorb([BIJ)V
...
.method private init(I)V
    ...
    invoke-direct {p0, p1, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->initSponge(II)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->initSponge(II)V
...
.method private initSponge(II)V
    ...
    iput p2, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->fixedOutputLength:I

    div-int/lit8 p1, p1, 0x8

    new-array p1, p1, [B

    iput-object p1, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->chunk:[B
...
.method private iota([JI)V
    ...
    sget-object v3, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakRoundConstants:[J
...
.method private static keccakInitializeRoundConstants()[J
    ...
    invoke-static {v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->LFSR86540([B)Z
...
.method private padAndSwitchToSqueezingPhase()V
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsInQueue:I
    ...
    invoke-direct {p0, v0, v2}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->clearDataQueueSection(II)V
    ...
    invoke-direct {p0, v0, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakExtract1024bits([B[B)V

    iput v2, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsAvailableForSqueezing:I
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->dataQueue:[B

    iget v3, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->rate:I

    div-int/lit8 v3, v3, 0x40

    invoke-direct {p0, v0, v2, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakExtract([B[BI)V
...
.method private pi([J)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->tempA:[J
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->tempA:[J
...
.method private rho([J)V
    ...
    sget-object v5, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakRhoOffsets:[I
    ...
    sget-object v7, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakRhoOffsets:[I
    ...
    sget-object v9, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakRhoOffsets:[I
...
.method private squeeze([BIJ)V
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsAvailableForSqueezing:I

    if-nez v2, :cond_3

    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->state:[B

    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->keccakPermutation([B)V
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->dataQueue:[B

    invoke-direct {p0, v2, v6}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakExtract1024bits([B[B)V

    iput v3, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsAvailableForSqueezing:I
    ...
    iget v6, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->rate:I

    div-int/lit8 v6, v6, 0x40

    invoke-direct {p0, v2, v3, v6}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->KeccakExtract([B[BI)V
    ...
    iget v7, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsAvailableForSqueezing:I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->bitsAvailableForSqueezing:I
...
.method private theta([J)V
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->C:[J
...
.method public update(B)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/digests/SHA3Digest;->oneByte:[B

    const-wide/16 v2, 0x8

    invoke-direct {p0, p1, v1, v2, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->doUpdate([BIJ)V
