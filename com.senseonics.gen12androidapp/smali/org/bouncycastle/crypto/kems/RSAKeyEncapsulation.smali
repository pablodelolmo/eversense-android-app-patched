...
.method public decrypt([BIII)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-static {p2, p1}, Lorg/bouncycastle/util/BigIntegers;->asUnsignedByteArray(ILjava/math/BigInteger;)[B
    ...
    invoke-interface {p2, p1, v3, p3}, Lorg/bouncycastle/crypto/DerivationFunction;->generateBytes([BII)I
...
.method public encrypt([BII)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/kems/RSAKeyEncapsulation;->kdf:Lorg/bouncycastle/crypto/DerivationFunction;

    new-instance p2, Lorg/bouncycastle/crypto/params/KDFParameters;

    const/4 v0, 0x0

    invoke-direct {p2, v3, v0}, Lorg/bouncycastle/crypto/params/KDFParameters;-><init>([B[B)V

    invoke-interface {p1, p2}, Lorg/bouncycastle/crypto/DerivationFunction;->init(Lorg/bouncycastle/crypto/DerivationParameters;)V
    ...
    invoke-interface {p2, p1, v2, p3}, Lorg/bouncycastle/crypto/DerivationFunction;->generateBytes([BII)I
