...
.method private processBlock()V
    ...
    invoke-static {v6, v7}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I
    ...
    invoke-static {v8, v9}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I
    ...
    invoke-static {v8, v12}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I
...
.method private setKey([B[B)V
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I
    ...
    invoke-interface {p1, v2, v4}, Lorg/bouncycastle/crypto/BlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/macs/Poly1305;->cipher:Lorg/bouncycastle/crypto/BlockCipher;

    invoke-interface {p1, p2, v3, v1, v3}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    invoke-static {v1, v3}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/crypto/macs/Poly1305;->k0:I

    const/4 p1, 0x4

    invoke-static {v1, p1}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/crypto/macs/Poly1305;->k1:I

    invoke-static {v1, v0}, Lorg/bouncycastle/crypto/util/Pack;->littleEndianToInt([BI)I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/crypto/macs/Poly1305;->k2:I
...
.method public doFinal([BI)I
    ...
    invoke-static {v2, p1, p2}, Lorg/bouncycastle/crypto/util/Pack;->intToLittleEndian(I[BI)V
    ...
    invoke-static {v0, p1, p2}, Lorg/bouncycastle/crypto/util/Pack;->intToLittleEndian(I[BI)V
...
.method public init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    const-string v0, "Poly1305 requires a key and and IV."
