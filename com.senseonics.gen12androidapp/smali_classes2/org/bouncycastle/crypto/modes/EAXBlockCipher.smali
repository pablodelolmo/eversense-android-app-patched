...
.method public doFinal([BI)I
    ...
    iget v7, p0, Lorg/bouncycastle/crypto/modes/EAXBlockCipher;->blockSize:I

    invoke-virtual {v3, v5, v6, v1, v7}, Lorg/bouncycastle/crypto/modes/SICBlockCipher;->processBlock([BI[BI)I
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {p2, v1, v3, v4}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    iget-object p2, p0, Lorg/bouncycastle/crypto/modes/EAXBlockCipher;->mac:Lorg/bouncycastle/crypto/Mac;

    array-length v1, p1

    invoke-interface {p2, p1, v3, v1}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
...
.method public processAADByte(B)V
    ...
    const-string v0, "AAD data cannot be added after encryption/decription processing has begun."
