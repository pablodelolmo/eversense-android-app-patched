...
.method private Block_Cipher_df([BI)[B
    ...
    iget v7, p0, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->_keySizeInBits:I

    div-int/2addr v7, v2

    new-array v2, v7, [B

    sget-object v7, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->K_BITS:[B
    ...
    invoke-direct {p0, v3, v7, v6}, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->copyIntToByteArray([BII)V

    invoke-direct {p0, v1, v2, v3, v4}, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->BCC([B[B[B[B)V
    ...
    :goto_1
    invoke-static {v1, v6, p1, v8, v9}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-interface {p2, v5, v3}, Lorg/bouncycastle/crypto/BlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v3, v1, v6, v1, v6}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
...
.method private CTR_DRBG_Reseed_algorithm(Lorg/bouncycastle/crypto/prng/EntropySource;[B)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->CTR_DRBG_Update([B[B[B)V
...
.method public generate([B[BZ)I
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->_entropySource:Lorg/bouncycastle/crypto/prng/EntropySource;

    invoke-direct {p0, p3, p2}, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->CTR_DRBG_Reseed_algorithm(Lorg/bouncycastle/crypto/prng/EntropySource;[B)V
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->addOneTo([B)V

    iget-object v2, p0, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->_engine:Lorg/bouncycastle/crypto/BlockCipher;

    iget-object v3, p0, Lorg/bouncycastle/crypto/prng/drbg/CTRSP800DRBG;->_V:[B

    invoke-interface {v2, v3, v0, p3, v0}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
