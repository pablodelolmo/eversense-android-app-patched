...
.method public processClientExtensions(Ljava/util/Hashtable;)V
    ...
    iput-short v1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->maxFragmentLengthOffered:S

    invoke-static {p1}, Lorg/bouncycastle/crypto/tls/TlsExtensionsUtils;->hasTruncatedHMacExtension(Ljava/util/Hashtable;)Z

    move-result v1

    iput-boolean v1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->truncatedHMacOffered:Z
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->supportedSignatureAlgorithms:Ljava/util/Vector;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->namedCurves:[I
    ...
    :cond_1
    iget-boolean p1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->eccCipherSuitesOffered:Z

    if-nez p1, :cond_3

    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->namedCurves:[I

    if-nez p1, :cond_2

    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsServer;->clientECPointFormats:[S
