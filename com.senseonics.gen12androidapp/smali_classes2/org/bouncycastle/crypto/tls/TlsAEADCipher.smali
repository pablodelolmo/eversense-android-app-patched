...
.method public decodeCiphertext(JS[BII)[B
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->getPlaintextLimit(I)I
    ...
    :cond_0
    iget-object v3, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptImplicitNonce:[B

    array-length v3, v3

    iget v4, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I

    add-int/2addr v3, v4

    new-array v3, v3, [B

    iget-object v4, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptImplicitNonce:[B

    iget-object v5, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptImplicitNonce:[B
    ...
    iget v5, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I

    move-object/from16 v8, p4

    invoke-static {v8, v1, v3, v4, v5}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    iget-object v1, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;

    invoke-interface {v1, v10}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->getOutputSize(I)I
    ...
    invoke-virtual {v0, v4, v5, v7, v1}, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B
    ...
    iget v7, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->macSize:I

    mul-int/lit8 v7, v7, 0x8

    invoke-direct {v4, v5, v7, v3, v1}, Lorg/bouncycastle/crypto/params/AEADParameters;-><init>(Lorg/bouncycastle/crypto/params/KeyParameter;I[B[B)V

    :try_start_0
    iget-object v1, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;

    invoke-interface {v1, v6, v4}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V

    iget-object v7, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;
    ...
    iget-object v3, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;

    invoke-interface {v3, v2, v1}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
...
.method public encodePlaintext(JS[BII)[B
    ...
    iget-object v3, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->encryptImplicitNonce:[B
    ...
    iget-object v5, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->encryptImplicitNonce:[B

    iget-object v6, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->encryptImplicitNonce:[B
    ...
    invoke-static {v1, v2, v3, v5}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V

    iget-object v5, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->encryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;

    invoke-interface {v5, v4}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->getOutputSize(I)I

    move-result v5

    iget v6, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I
    ...
    invoke-static {v3, v5, v8, v7, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget v7, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I

    move v5, p3

    invoke-virtual {v0, v1, v2, v5, v4}, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B

    move-result-object v1

    new-instance v2, Lorg/bouncycastle/crypto/params/AEADParameters;

    iget v5, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->macSize:I

    mul-int/lit8 v5, v5, 0x8

    const/4 v6, 0x0

    invoke-direct {v2, v6, v5, v3, v1}, Lorg/bouncycastle/crypto/params/AEADParameters;-><init>(Lorg/bouncycastle/crypto/params/KeyParameter;I[B[B)V

    const/16 v9, 0x50

    :try_start_0
    iget-object v1, v0, Lorg/bouncycastle/crypto/tls/TlsAEADCipher;->encryptCipher:Lorg/bouncycastle/crypto/modes/AEADBlockCipher;

    const/4 v3, 0x1

    invoke-interface {v1, v3, v2}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v1, v8, v7}, Lorg/bouncycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
