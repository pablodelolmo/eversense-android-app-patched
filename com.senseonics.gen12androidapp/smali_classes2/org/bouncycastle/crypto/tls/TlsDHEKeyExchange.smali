...
.method public generateServerKeyExchange()[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsDHEKeyExchange;->context:Lorg/bouncycastle/crypto/tls/TlsContext;

    invoke-interface {v2}, Lorg/bouncycastle/crypto/tls/TlsContext;->getSecureRandom()Ljava/security/SecureRandom;

    move-result-object v2

    iget-object v3, p0, Lorg/bouncycastle/crypto/tls/TlsDHEKeyExchange;->dhParameters:Lorg/bouncycastle/crypto/params/DHParameters;

    invoke-static {v2, v3, v0}, Lorg/bouncycastle/crypto/tls/TlsDHUtils;->generateEphemeralServerKeyExchange(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/params/DHParameters;Ljava/io/OutputStream;)Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;

    move-result-object v2

    iput-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsDHEKeyExchange;->dhAgreeServerPrivateKey:Lorg/bouncycastle/crypto/params/DHPrivateKeyParameters;
    ...
    invoke-interface {v2}, Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;->getSignatureAndHashAlgorithm()Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;
    ...
    invoke-interface {v1, v4, v6, v5}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v1, v4, v6, v3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/tls/DigestInputBuffer;->updateDigest(Lorg/bouncycastle/crypto/Digest;)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsDHEKeyExchange;->serverCredentials:Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;

    invoke-interface {v1, v3}, Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;->generateCertificateSignature([B)[B

    move-result-object v1

    new-instance v3, Lorg/bouncycastle/crypto/tls/DigitallySigned;

    invoke-direct {v3, v2, v1}, Lorg/bouncycastle/crypto/tls/DigitallySigned;-><init>(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;[B)V
...
.method public processServerKeyExchange(Ljava/io/InputStream;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsDHEKeyExchange;->dhAgreeServerPublicKey:Lorg/bouncycastle/crypto/params/DHPublicKeyParameters;
