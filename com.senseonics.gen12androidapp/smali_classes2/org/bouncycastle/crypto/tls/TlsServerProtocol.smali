...
.method public accept(Lorg/bouncycastle/crypto/tls/TlsServer;)V
    ...
    new-instance p1, Lorg/bouncycastle/crypto/tls/SecurityParameters;

    invoke-direct {p1}, Lorg/bouncycastle/crypto/tls/SecurityParameters;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->securityParameters:Lorg/bouncycastle/crypto/tls/SecurityParameters;
    ...
    iput v0, p1, Lorg/bouncycastle/crypto/tls/SecurityParameters;->entity:I
    ...
    new-instance p1, Lorg/bouncycastle/crypto/tls/TlsServerContextImpl;
    ...
    invoke-direct {p1, v1, v2}, Lorg/bouncycastle/crypto/tls/TlsServerContextImpl;-><init>(Ljava/security/SecureRandom;Lorg/bouncycastle/crypto/tls/SecurityParameters;)V
    ...
    invoke-interface {p1, v1}, Lorg/bouncycastle/crypto/tls/TlsServer;->init(Lorg/bouncycastle/crypto/tls/TlsServerContext;)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->recordStream:Lorg/bouncycastle/crypto/tls/RecordStream;

    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->tlsServerContext:Lorg/bouncycastle/crypto/tls/TlsServerContextImpl;

    invoke-virtual {p1, v1}, Lorg/bouncycastle/crypto/tls/RecordStream;->init(Lorg/bouncycastle/crypto/tls/TlsContext;)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->recordStream:Lorg/bouncycastle/crypto/tls/RecordStream;

    invoke-virtual {p1, v0}, Lorg/bouncycastle/crypto/tls/RecordStream;->setRestrictReadVersion(Z)V
...
.method protected handleHandshakeMessage(S[B)V
    ...
    invoke-interface {p1, v0}, Lorg/bouncycastle/crypto/tls/TlsKeyExchange;->processServerCredentials(Lorg/bouncycastle/crypto/tls/TlsCredentials;)V
    ...
    :cond_12
    iget-boolean p1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->allowCertificateStatus:Z

    if-eqz p1, :cond_13

    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/bouncycastle/crypto/tls/TlsServer;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/tls/TlsServer;->getCertificateStatus()Lorg/bouncycastle/crypto/tls/CertificateStatus;

    move-result-object p1

    if-eqz p1, :cond_13

    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->sendCertificateStatusMessage(Lorg/bouncycastle/crypto/tls/CertificateStatus;)V
    ...
    invoke-interface {p1}, Lorg/bouncycastle/crypto/tls/TlsKeyExchange;->generateServerKeyExchange()[B

    move-result-object p1

    if-eqz p1, :cond_14

    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->sendServerKeyExchangeMessage([B)V
    ...
    invoke-interface {p1}, Lorg/bouncycastle/crypto/tls/TlsServer;->getCertificateRequest()Lorg/bouncycastle/crypto/tls/CertificateRequest;
    ...
    invoke-interface {p1, v0}, Lorg/bouncycastle/crypto/tls/TlsKeyExchange;->validateCertificateRequest(Lorg/bouncycastle/crypto/tls/CertificateRequest;)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->trackHashAlgorithms(Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;Ljava/util/Vector;)V
...
.method protected receiveCertificateVerifyMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    invoke-static {p1, v1, v2}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->getCurrentPRFHash(Lorg/bouncycastle/crypto/tls/TlsContext;Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;[B)[B

    move-result-object p1

    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->peerCertificate:Lorg/bouncycastle/crypto/tls/Certificate;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lorg/bouncycastle/crypto/tls/Certificate;->getCertificateAt(I)Lorg/bouncycastle/asn1/x509/Certificate;
    ...
    iget-short v2, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->clientCertificateType:S

    invoke-static {v2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->createTlsSigner(S)Lorg/bouncycastle/crypto/tls/TlsSigner;
    ...
    invoke-interface {v2, v3}, Lorg/bouncycastle/crypto/tls/TlsSigner;->init(Lorg/bouncycastle/crypto/tls/TlsContext;)V
    ...
    invoke-interface {v2, v3, v0, v1, p1}, Lorg/bouncycastle/crypto/tls/TlsSigner;->verifyRawSignature(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;[BLorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B)Z
    :try_end_0
...
.method protected sendServerHelloMessage()V
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/tls/AbstractTlsContext;->getClientVersion()Lorg/bouncycastle/crypto/tls/ProtocolVersion;
    ...
    invoke-virtual {v2, v1}, Lorg/bouncycastle/crypto/tls/RecordStream;->setPlaintextLimit(I)V
