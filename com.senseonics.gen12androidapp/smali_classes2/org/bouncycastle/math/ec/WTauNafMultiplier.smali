...
.method private static multiplyFromWTnaf(Lorg/bouncycastle/math/ec/ECPoint$F2m;[BLorg/bouncycastle/math/ec/PreCompInfo;)Lorg/bouncycastle/math/ec/ECPoint$F2m;
    ...
    :cond_1
    :goto_0
    invoke-static {p0, v1}, Lorg/bouncycastle/math/ec/Tnaf;->getPreComp(Lorg/bouncycastle/math/ec/ECPoint$F2m;B)[Lorg/bouncycastle/math/ec/ECPoint$F2m;

    move-result-object p2

    new-instance v1, Lorg/bouncycastle/math/ec/WTauNafPreCompInfo;

    invoke-direct {v1, p2}, Lorg/bouncycastle/math/ec/WTauNafPreCompInfo;-><init>([Lorg/bouncycastle/math/ec/ECPoint$F2m;)V

    invoke-virtual {v0, p0, v1}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->setPreCompInfo(Lorg/bouncycastle/math/ec/ECPoint;Lorg/bouncycastle/math/ec/PreCompInfo;)V
...
.method protected multiplyPositive(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/math/ec/ECPoint$F2m;->getCurve()Lorg/bouncycastle/math/ec/ECCurve;
    ...
    invoke-virtual {p1, v1}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->getPreCompInfo(Lorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/math/ec/PreCompInfo;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/bouncycastle/math/ec/WTauNafMultiplier;->multiplyWTnaf(Lorg/bouncycastle/math/ec/ECPoint$F2m;Lorg/bouncycastle/math/ec/ZTauElement;Lorg/bouncycastle/math/ec/PreCompInfo;BB)Lorg/bouncycastle/math/ec/ECPoint$F2m;
