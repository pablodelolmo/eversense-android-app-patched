...
.method public static createClientCert(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, v0, v2, v1}, Lorg/bouncycastle/x509/X509V3CertificateGenerator;->addExtension(Lorg/bouncycastle/asn1/DERObjectIdentifier;ZLorg/bouncycastle/asn1/ASN1Encodable;)V
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string v1, "9f66f6b05410cd503b2709e88115d55daced94d1a34d4e32bf824d0dde6028ae79c5f07b580f5dce240d7111f7ddb130a7945cd7d957d1920994da389f490c89"

    invoke-direct {v7, v1, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v8, Ljava/math/BigInteger;

    const-string v1, "c0a0758cdf14256f78d4708c86becdead1b50ad4ad6c5c703e2168fbf37884cb"

    invoke-direct {v8, v1, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v9, Ljava/math/BigInteger;

    const-string v1, "f01734d7960ea60070f1b06f2bb81bfac48ff192ae18451d5e56c734a5aab8a5"

    invoke-direct {v9, v1, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v10, Ljava/math/BigInteger;

    const-string v1, "b54bb9edff22051d9ee60f9351a48591b6500a319429c069a3e335a1d6171391"

    invoke-direct {v10, v1, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v11, Ljava/math/BigInteger;

    const-string v1, "d3d83daf2a0cecd3367ae6f8ae1aeb82e9ac2f816c6fc483533d8297dd7884cd"

    invoke-direct {v11, v1, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v12, Ljava/math/BigInteger;

    const-string v1, "b8f52fc6f38593dabb661d3f50f8897f8106eee68b1bce78a95b132b4e5b5d19"
    ...
    const-string v4, ""

    invoke-direct {v9, v4, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v10, Ljava/math/BigInteger;

    const-string v4, "f75e80839b9b9379f1cf1128f321639757dba514642c206bbbd99f9a4846208b3e93fbbe5e0527cc59b1d4b929d9555853004c7c8b30ee6a213c3d1bb7415d03"

    invoke-direct {v10, v4, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v11, Ljava/math/BigInteger;

    const-string v4, "b892d9ebdbfc37e397256dd8a5d3123534d1f03726284743ddc6be3a709edb696fc40c7d902ed804c6eee730eee3d5b20bf6bd8d87a296813c87d3b3cc9d7947"

    invoke-direct {v11, v4, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v12, Ljava/math/BigInteger;

    const-string v4, "1d1a2d3ca8e52068b3094d501c9a842fec37f54db16e9a67070a8b3f53cc03d4257ad252a1a640eadd603724d7bf3737914b544ae332eedf4f34436cac25ceb5"

    invoke-direct {v12, v4, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v13, Ljava/math/BigInteger;

    const-string v4, "6c929e4e81672fef49d9c825163fec97c4b7ba7acb26c0824638ac22605d7201c94625770984f78a56e6e25904fe7db407099cad9b14588841b94f5ab498dded"

    invoke-direct {v13, v4, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v14, Ljava/math/BigInteger;

    const-string v4, "dae7651ee69ad1d081ec5e7188ae126f6004ff39556bde90e0b870962fa7b926d070686d8244fe5a9aa709a95686a104614834b0ada4b10f53197a5cb4c97339"

    invoke-direct {v14, v4, v2}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-static {v1, v3}, Lorg/bouncycastle/x509/examples/AttrCertExample;->createAcIssuerCert(Ljava/security/PublicKey;Ljava/security/PrivateKey;)Ljava/security/cert/X509Certificate;

    move-result-object v0

    invoke-static {p0, v3, v1}, Lorg/bouncycastle/x509/examples/AttrCertExample;->createClientCert(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;)Ljava/security/cert/X509Certificate;

    move-result-object p0

    new-instance v2, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;

    invoke-direct {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;-><init>()V

    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->reset()V

    new-instance v4, Lorg/bouncycastle/x509/AttributeCertificateHolder;

    invoke-direct {v4, p0}, Lorg/bouncycastle/x509/AttributeCertificateHolder;-><init>(Ljava/security/cert/X509Certificate;)V

    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setHolder(Lorg/bouncycastle/x509/AttributeCertificateHolder;)V

    new-instance v4, Lorg/bouncycastle/x509/AttributeCertificateIssuer;

    invoke-virtual {v0}, Ljava/security/cert/X509Certificate;->getSubjectX500Principal()Ljavax/security/auth/x500/X500Principal;

    move-result-object v5

    invoke-direct {v4, v5}, Lorg/bouncycastle/x509/AttributeCertificateIssuer;-><init>(Ljavax/security/auth/x500/X500Principal;)V

    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setIssuer(Lorg/bouncycastle/x509/AttributeCertificateIssuer;)V
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setSerialNumber(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setNotBefore(Ljava/util/Date;)V
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setNotAfter(Ljava/util/Date;)V

    const-string v4, "SHA1WithRSAEncryption"

    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->setSignatureAlgorithm(Ljava/lang/String;)V

    new-instance v4, Lorg/bouncycastle/asn1/x509/GeneralName;

    const-string v5, "DAU123456789"

    const/4 v6, 0x1

    invoke-direct {v4, v6, v5}, Lorg/bouncycastle/asn1/x509/GeneralName;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v4, v6, v7}, Lorg/bouncycastle/x509/X509Attribute;-><init>(Ljava/lang/String;Lorg/bouncycastle/asn1/ASN1Encodable;)V

    invoke-virtual {v2, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->addAttribute(Lorg/bouncycastle/x509/X509Attribute;)V

    const-string v4, "BC"

    invoke-virtual {v2, v3, v4}, Lorg/bouncycastle/x509/X509V2AttributeCertificateGenerator;->generate(Ljava/security/PrivateKey;Ljava/lang/String;)Lorg/bouncycastle/x509/X509AttributeCertificate;

    move-result-object v2

    check-cast v2, Lorg/bouncycastle/x509/X509V2AttributeCertificate;

    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getHolder()Lorg/bouncycastle/x509/AttributeCertificateHolder;

    move-result-object v3

    invoke-virtual {v3, p0}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->match(Ljava/security/cert/Certificate;)Z
    ...
    const-string v5, " entity names found"
    ...
    const-string v5, " issuer names found, serial number "
    ...
    const-string v3, "Matches original client x509 cert"

    invoke-virtual {p0, v3}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    :cond_2
    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getIssuer()Lorg/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    const-string p0, " entity names found"
    ...
    const-string v0, "Matches original ca x509 cert"
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getNotBefore()Ljava/util/Date;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getNotAfter()Ljava/util/Date;
    ...
    :try_start_0
    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->checkValidity()V

    new-instance p0, Ljava/util/Date;

    invoke-direct {p0}, Ljava/util/Date;-><init>()V

    invoke-virtual {v2, p0}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->checkValidity(Ljava/util/Date;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, p0}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_1
    invoke-virtual {v2}, Lorg/bouncycastle/x509/X509V2AttributeCertificate;->getAttributes()[Lorg/bouncycastle/x509/X509Attribute;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/x509/X509Attribute;->getOID()Ljava/lang/String;
    ...
    const-string v2, "rolesyntax read from cert!"
